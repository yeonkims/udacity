...
class SleepTrackerViewModel(val database: SleepDatabaseDao, application: Application) :
    ...
    // Create tonight liveData var and use a coroutine to initialized it from the database.
    ...
    // Implement click handlers for Start, Stop, Clear buttons using coroutines to do the database work.
    // Add local functions for insert(), update(), clear()
    fun onStartTracking() {
        uiScope.launch {
